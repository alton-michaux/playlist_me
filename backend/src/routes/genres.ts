...
// Spotify deprecated /recommendations/available-genre-seeds in Nov 2023.
// This is the canonical seed genre list — it hasn't meaningfully changed.
const GENRE_SEEDS = [
...
/** GET /genres — returns available genre seeds. */
router.get('/', (_req, res) => {
  res.json({ genres: GENRE_SEEDS });
});
